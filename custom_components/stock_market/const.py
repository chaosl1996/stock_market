...
# 各市场交易时间段配置（北京时间）
# 格式：{市场类型: [(开始时间, 结束时间), ...]}
# 每个市场可能有多个交易时段（如港股有上午和下午）
MARKET_TRADING_HOURS = {
    "上证": [("09:30", "11:30"), ("13:00", "15:00")],
    "深证": [("09:30", "11:30"), ("13:00", "15:00")],
    "科创": [("09:30", "11:30"), ("13:00", "15:00")],
    "中小板": [("09:30", "11:30"), ("13:00", "15:00")],
    "创业板": [("09:30", "11:30"), ("13:00", "15:00")],
    "美股": [("21:30", "04:00")],  # 夏令时
    "港股": [("09:30", "12:00"), ("13:00", "16:00")],
    "日股": [("09:00", "11:30"), ("12:30", "15:00")],
    "英股": [("15:00", "23:30")],  # 夏令时
    "德股": [("15:30", "23:00")]   # 夏令时
}

# 默认更新间隔配置
DEFAULT_SCAN_INTERVAL_TRADE = 120  # 交易时间段内默认更新间隔（秒）
DEFAULT_SCAN_INTERVAL_NON_TRADE = 3600  # 非交易时间段默认更新间隔（秒）